# Mikrotik Router
![GitHub release (latest by date)](https://img.shields.io/github/v/release/carpenike/homeassistant-mikrotik_router?style=plastic)
...
![GitHub all releases](https://img.shields.io/github/downloads/carpenike/homeassistant-mikrotik_router/total?style=plastic)

![GitHub commits since latest release](https://img.shields.io/github/commits-since/carpenike/homeassistant-mikrotik_router/latest?style=plastic)
[![hacs_badge](https://img.shields.io/badge/HACS-Default-orange.svg?style=plastic)](https://github.com/custom-components/hacs)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/carpenike/homeassistant-mikrotik_router?style=plastic)
![Project Maintenance](https://img.shields.io/badge/maintainer-Ryan%20Holt%20%40carpenike-blue.svg?style=plastic)
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/carpenike/homeassistant-mikrotik_router/ci.yml?style=plastic)
...
If you want to add translations for a language that is not listed please [open a Feature request](https://github.com/carpenike/homeassistant-mikrotik_router/issues/new?labels=enhancement&title=%5BLokalise%5D%20Add%20new%20translations%20language).
